...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (contactForm) {
    ...
    if (_vendor_js_cookie_min_js__WEBPACK_IMPORTED_MODULE_4___default().get("succContactForm") == "Yes") {
      ...
      (0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_3__.validateForms)("#contact-form", rulesContact, afterFormContact);
    }
  }
  ...
  if (formConsultation) {
    ...
    if (_vendor_js_cookie_min_js__WEBPACK_IMPORTED_MODULE_4___default().get("succConsForm") == "Yes") {
      ...
      (0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_3__.validateForms)("#form-consultation", rulesCons, afterFormCons);
    }
  }
});
})();
