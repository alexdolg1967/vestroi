...
const validateForms = (selector, rules, afterSend, error) => {
...
/* harmony import */ var _vendor_js_cookie_min_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./vendor/js.cookie.min.js */ "./src/js/vendor/js.cookie.min.js");
/* harmony import */ var _vendor_js_cookie_min_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_vendor_js_cookie_min_js__WEBPACK_IMPORTED_MODULE_4__);
...
window.onload = function () {
  ...
  ScrollReveal().reveal(".benefit, swiper-slide", {
    interval: 100
  });
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (contactForm) {
    ...
    if (_vendor_js_cookie_min_js__WEBPACK_IMPORTED_MODULE_4___default().get("succContactForm") == "Yes") {
      ...
      const afterFormContact = () => {
        succContactForm.classList.add("message--show");
        succContactForm.innerHTML = "Ваши контакты успешно отправлены! Мы свяжемся с Вами в ближайшее время.";
        contactForm.classList.add("is-hidden");
        _vendor_js_cookie_min_js__WEBPACK_IMPORTED_MODULE_4___default().set("succContactForm", "Yes", {
          expires: 1
        });
      };
      const errorFormContact = () => {
        ...
        succContactForm.innerHTML = "К сожалению в данный момент отправка невозможна!";
        contactForm.classList.add("is-hidden");
      };
      (0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_3__.validateForms)("#contact-form", rulesContact, afterFormContact, errorFormContact);
    }
  }
  const formConsultation = document.querySelector("#form-consultation");
  if (formConsultation) {
    const succConsForm = document.getElementById("succ-cons");
    if (_vendor_js_cookie_min_js__WEBPACK_IMPORTED_MODULE_4___default().get("succConsForm") == "Yes") {
      ...
      const afterFormCons = () => {
        succConsForm.classList.add("message--show");
        succConsForm.innerHTML = "Ваша заявка на консультацию успешно отправлена! Мы свяжемся с Вами в ближайшее время.";
        formConsultation.classList.add("is-hidden");
        _vendor_js_cookie_min_js__WEBPACK_IMPORTED_MODULE_4___default().set("succConsForm", "Yes", {
          expires: 1
        });
      };
      const error = () => {
        ...
        succConsForm.innerHTML = "К сожалению в данный момент отправка невозможна!";
        formConsultation.classList.add("is-hidden");
      };
      (0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_3__.validateForms)("#form-consultation", rulesCons, afterFormCons, error);
    }
  }
});
})();
