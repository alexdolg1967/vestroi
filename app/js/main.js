...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (formConsultation) {
    ...
    if (_vendor_js_cookie_min_js__WEBPACK_IMPORTED_MODULE_4___default().get("succForm") == "Yes") {
      ...
      const afterFormCons = () => {
        succForm.classList.add("message--show");
        succForm.innerHTML = "Ваше сообщение успешно отправлено! Мы свяжемся с Вами в ближайшее время.";
